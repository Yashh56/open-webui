...
app.state.config.BRAVE_SEARCH_COUNTRY = BRAVE_SEARCH_COUNTRY
app.state.config.BRAVE_SEARCH_LANG = BRAVE_SEARCH_LANG
app.state.config.BRAVE_SEARCH_SPELLCHECK = BRAVE_SEARCH_SPELLCHECK
app.state.config.BRAVE_SEARCH_MAX_TOKENS = BRAVE_SEARCH_MAX_TOKENS
app.state.config.BRAVE_SEARCH_MAX_TOKENS_PER_URL = BRAVE_SEARCH_MAX_TOKENS_PER_URL
app.state.config.BRAVE_SEARCH_MAX_SNIPPETS_PER_URL = BRAVE_SEARCH_MAX_SNIPPETS_PER_URL
app.state.config.BRAVE_SEARCH_CONTEXT_THRESHOLD_MODE = BRAVE_SEARCH_CONTEXT_THRESHOLD_MODE
app.state.config.BRAVE_SEARCH_FRESHNESS = BRAVE_SEARCH_FRESHNESS
app.state.config.BRAVE_SEARCH_GOGGLES = BRAVE_SEARCH_GOGGLES
